...
function jour_ferie($date){
  ...
  // dates fériées fixes
  if($jour == 1 && $mois == 1) return "Jour de l'an";
  if($jour == 1 && $mois == 5) return "Fête du travail";
  if($jour == 8 && $mois == 5) return "8 mai 1945";
  if($jour == 14 && $mois == 7) return "Fête nationale";
  if($jour == 15 && $mois == 8) return "Assomption";
  if($jour == 1 && $mois == 11) return "La Toussaint";
  if($jour == 11 && $mois == 11) return "Armistice";
  if($jour == 25 && $mois == 12) return "Noël";
