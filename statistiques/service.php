      ...
      // Vérifie à partir de la table absences si l'agent est absent
        ...
        $dimanche[$elem['date']][0]=$elem['date'];
              $dimanche[$elem['date']][1]=0;
                    ...
                    $tab[$service]=array($elem['service'],$postes,$heures,$samedi,$absences,$total_absences,$dimanche,$heures_tab,$feries,"sites"=>$sites);
                }
            }
        }
    }
...
echo "<td><select name='services[]' multiple='multiple' size='20' onchange='verif_select(\"services\");' class='ui-widget-content ui-corner-all' >\n";
...
echo "<input type='button' value='Effacer' onclick='location.href=\"index.php?page=statistiques/service.php&amp;debut=&amp;fin=&amp;agents=\"' class='ui-button' />\n";
...
if ($tab) {
    ...
    echo "&nbsp;:&nbsp;".heure4($dimanche[1])."<br/>";	//	heures
        ...
        if ($exists_JF) {
            ...
            echo count($elem[8])." $ferie";		//	nombre de jours fériés
            echo "<br/>\n";
