...
$sql[]="INSERT INTO `{$dbprefix}config` (`nom`, `type`, `valeur`, `commentaires`, `categorie`, `valeurs`, `ordre`) VALUES ('Version', 'info', '25.05.06', 'Version de l\'application',' Divers','','0');";
...
$sql[]="INSERT INTO `{$dbprefix}config` (`nom`, `type`, `valeur`, `commentaires`, `categorie`, `valeurs`, `ordre`) VALUES ('Mail-SMTPAuth', 'boolean', '0', 'Le serveur SMTP requiert-il une authentification ?', 'Messagerie', '', '80');";
$sql[]="INSERT INTO `{$dbprefix}config` (`nom`, `type`, `valeur`, `commentaires`, `categorie`, `valeurs`, `ordre`) VALUES ('Mail-Username', '', '', 'Nom d\'utilisateur pour le serveur SMTP.', 'Messagerie', '', '90');";
$sql[]="INSERT INTO `{$dbprefix}config` (`nom`, `type`, `valeur`, `commentaires`, `categorie`, `valeurs`, `ordre`) VALUES ('Mail-Password', 'password', '', 'Mot de passe pour le serveur SMTP.', 'Messagerie', '', '100');";
$sql[]="INSERT INTO `{$dbprefix}config` (`nom`, `type`, `valeur`, `commentaires`, `categorie`, `valeurs`, `ordre`) VALUES ('Mail-From', '', 'no-reply@planno.fr', 'Adresse e-mail de l\'expediteur.', 'Messagerie', '', '110');";
$sql[]="INSERT INTO `{$dbprefix}config` (`nom`, `type`, `valeur`, `commentaires`, `categorie`, `valeurs`, `ordre`) VALUES ('Mail-FromName', '', 'Planno', 'Nom de l\'expediteur.', 'Messagerie', '', '120');";
...
$sql[]="INSERT INTO `{$dbprefix}menu` (`niveau1`,`niveau2`,`titre`,`url`,`condition`) VALUES
  ...
  ('15','0','Congés','/holiday','config=Conges-Enable'),
  ('15','10','Liste des cong&eacute;s','/holiday','config=Conges-Enable'),
  ('15','15','Liste des r&eacute;cup&eacute;rations','/holiday?recup=1','config=Conges-Enable;Conges-Recuperations'),
