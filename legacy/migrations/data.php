...
$sql[]="INSERT INTO `{$dbprefix}config` (`nom`, `type`, `valeur`, `categorie`, `commentaires`, `technical`, `ordre` ) VALUES
  ('ICS-Delay', 'text', '1', 'ICS', 'D&eacute;lai entre chaque requ&ecirc;te ICS lors de l\'import', 1, '71');";
