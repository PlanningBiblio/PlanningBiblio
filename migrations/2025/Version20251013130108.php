...
final class Version20251013130108 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("UPDATE {$dbprefix}cron SET command='app:holiday:reminder' WHERE command='cron.holiday_reset_remainder.php';");
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql("UPDATE {$dbprefix}cron SET command='cron.holiday_reset_remainder.php' WHERE command='app:holiday:reminder';");
