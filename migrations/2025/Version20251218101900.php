...
final class Version20251218101900 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("INSERT IGNORE INTO `{$dbprefix}config` (`nom`, `type`, `valeur`, `categorie`, `commentaires`, `technical`, `ordre`) VALUES ('AbsImport-Reason', 'text', '', 'Absences Import CSV', 'Motif pour les absences importées par fichier CSV', 1, '2');");
