...
$fromMail = filter_input(INPUT_POST, 'fromMail', FILTER_SANITIZE_EMAIL);
$replyTo = filter_input(INPUT_POST, 'replyTo', FILTER_SANITIZE_EMAIL);
$returnPath = filter_input(INPUT_POST, 'returnPath', FILTER_SANITIZE_EMAIL);
...
if ($fp=@fsockopen($host, $port, $errno, $errstr, 5)) {
    ...
    $config['Mail-ReplyTo'] = $replyTo;
    $config['Mail-ReturnPath'] = $returnPath;
