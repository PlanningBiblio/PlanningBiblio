...
class HolidayControllerAddTest extends PLBWebTestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        $jdupont->setACL(array(3,4,5,6,9,17,20,21,22,23,25,99,100,201,202,301,302,401,402,501,502,701,801,802,901,1001,1002,1101,1201,1301));
