...
class PositionControllerTest extends PLBWebTestCase
{
    ...
    public function testNewForm(): void
    {
        ...
        $result = $crawler->filterXPath('//input[@class="form-control form-control-sm"]');
        $this->assertEquals($result->attr('name'),'nom','input for post name value is nom');

        $result = $crawler->filter('div .container');
        ...
        $this->assertStringContainsString('Activités :',$result->text('Node does not exist', false), 'Activités :');
        $this->assertStringContainsString('Assistance audiovisuel', $result->text('Node does not exist', false), 'checkBox is Assistance audiovisuel');
        $this->assertStringContainsString('Assistance autoformation', $result->text('Node does not exist', false), 'checkBox is Assistance autoformation');
        $this->assertStringContainsString('Communication', $result->text('Node does not exist', false), 'checkBox is Communication');
        $this->assertStringContainsString('Communication réserve', $result->text('Node does not exist', false), 'checkBox is Communication réserve');
        $this->assertStringContainsString('Inscription', $result->text('Node does not exist', false), 'checkBox is Inscription');
        $this->assertStringContainsString('Prêt/retour de document', $result->text('Node does not exist', false), 'checkBox is Prêt/retour de document');
        $this->assertStringContainsString('Prêt de matériel', $result->text('Node does not exist', false), 'checkBox is Prêt de matériel');
        $this->assertStringContainsString('Rangement', $result->text('Node does not exist', false), 'checkBox is Rangement');
        $this->assertStringContainsString('Renseignement', $result->text('Node does not exist', false), 'checkBox is Renseignement');
        $this->assertStringContainsString('Renseignement bibliographique', $result->text('Node does not exist', false), 'checkBox is Renseignement bibliographique ');
        $this->assertStringContainsString('Renseignement réserve', $result->text('Node does not exist', false), 'checkBox is Renseignement réserve');
        $this->assertStringContainsString('Renseignement spécialisé', $result->text('Node does not exist', false), 'checkBox is Renseignement spécialisé');
        $this->assertStringContainsString('Catégories',$result->text('Node does not exist', false), 'label is Catégorie');
        $this->assertStringContainsString('Catégorie A', $result->text('Node does not exist', false), 'checkBox is Catégorie A ');
        $this->assertStringContainsString('Catégorie B', $result->text('Node does not exist', false), 'checkBox is Catégorie B');
        $this->assertStringContainsString('Catégorie C', $result->text('Node does not exist', false), 'checkBox is Catégorie C');
        ...
        $result = $crawler->filterXPath('//button[@class="btn btn-primary"]');
        $this->assertEquals($result->text('Node does not exist', false),'Valider','input submit value is Valider');
    ...
    public function testFormEdit(): void
    {
        ...
        $this->assertStringContainsString('Nom du poste :',$result->text('Node does not exist', false), 'label is Nom du poste');
