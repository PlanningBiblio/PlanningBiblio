...
class AbsenceControllerEditTest extends PLBWebTestCase
{
    ...
    public function testMultipleAgentSelectionWithoutPreselection():void 
    {
    ...
    public function testValidationStateWithoutPreselection():void 
    {
    ...
    public function testValidationStateWithPreselection():void 
    {
