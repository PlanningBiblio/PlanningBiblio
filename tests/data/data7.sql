...
(5,15,0,'Congés','/holiday','config=Conges-Enable'),
(6,15,10,'Liste des cong&eacute;s','/holiday','config=Conges-Enable'),
(7,15,15,'Liste des r&eacute;cup&eacute;rations','/holiday?recup=1','config=Conges-Enable;Conges-Recuperations'),
