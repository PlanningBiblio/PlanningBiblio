...
class PlanningPositionHistoryHelper extends BaseHelper
{
    ...
    public function add($date, $start, $end, ?int $site, ?int $position, ?int $login_id, $perso_id, $playBefore = false): void
    {
    ...
    public function disable($date, $start, $end, ?int $site, ?int $position, ?int $login_id, $perso_id_origine): void
    {
    ...
    public function cross($date, $start, $end, ?int $site, ?int $position, ?int $login_id, $perso_id = null): void
    {
    ...
    public function delete($date, $start, $end, ?int $site, ?int $position, ?int $login_id, $perso_id = null): void
    {
    ...
    public function delete_plannings($session, $start, $end, ?int $site, ?string $reason = 'delete-planning'): void
    {
    ...
    private function save(?string $action, $date, $start, $end, ?int $site, ?int $position, ?int $login_id, array $perso_ids, bool $playBefore = false): \App\Entity\PlanningPositionHistory
    {
