...
if (strcmp($v, $config['Version'])>0 and strcmp($v, $version)<=0) {
    ...
    if (in_array('conges', $plugins)) {
        ...
        $sql[]="UPDATE `{$dbprefix}menu` SET url='conges/voir.php' WHERE url='plugins/conges/voir.php';";
        $sql[]="UPDATE `{$dbprefix}menu` SET url='conges/enregistrer.php' WHERE url='plugins/conges/enregistrer.php';";
        $sql[]="UPDATE `{$dbprefix}menu` SET url='conges/recuperations.php' WHERE url='plugins/conges/recuperations.php';";
        $sql[]="UPDATE `{$dbprefix}menu` SET url='conges/infos.php' WHERE url='plugins/conges/infos.php';";
        $sql[]="UPDATE `{$dbprefix}menu` SET url='conges/credits.php' WHERE url='plugins/conges/credits.php';";
