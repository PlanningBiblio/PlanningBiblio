...
elseif($confirm=="confirm1"){		//	1ere Confirmation
  ...
  if($datesValidees){
    if($admin){
      echo "<p style='color:red;text-align:justify;'>Attention, l'agent sélectionné apparaît dans des plannings validés : $datesValidees <br/></p>\n";
    }
    else{
  ...
  echo "</select>\n";
  if(in_array(1,$droits))
    echo "<a href='javascript:popup(\"include/ajoutSelect.php&amp;table=select_abs&amp;terme=modif\",400,400);'>*</a>\n";
