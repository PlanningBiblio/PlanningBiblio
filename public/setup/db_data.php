...
$sql[]="INSERT INTO `{$dbprefix}config` (`nom`, `type`, `valeur`, `commentaires`, `categorie`, `ordre`) VALUES ('Journey-time-between-sites', 'text', '20', 'Time it takes an agent to travel between sites (minutes)', 'Planning', 95);";
