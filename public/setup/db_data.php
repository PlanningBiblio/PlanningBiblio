...
$sql[]="INSERT INTO `{$dbprefix}config` (`nom`, `type`, `valeur`, `commentaires`, `categorie`, `valeurs`, `ordre`) VALUES ('Version', 'info', '20.05.00.002', 'Version de l&apos;application',' Divers','','0');";
...
$sql[]="INSERT INTO `{$dbprefix}config` (`nom`, `type`, `valeur`, `commentaires`, `categorie`, `ordre`) VALUES ('Journey-time-between-floors', 'text', '0', 'Time it takes an agent to travel between floors (minutes)', 'Planning', 95);";
