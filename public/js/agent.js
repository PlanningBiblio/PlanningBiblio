  ...
  $('#modif-agent-form').on('submit', function(e) {
    ...
    $.ajax({
      ...
      success: function(result) {
        if (result=='ok') {
          var msg = Translator.trans('The agents were successfully modified');
          var msgType = 'success';
        } else {
          var msg = result;
          var msgType = 'error';
      ...
      error: function() {
        var msg = Translator.trans('An error occurred while modifying the agents');
        location.href = url('agent?msg=' + msg + '&msgType=error');
      }
    });
  })
});
...
function agent_list() {
  if (!$('.checkbox:visible:checked').length) {
    var msg = Translator.trans('Please select one or more agents.');
    alert(msg);
    return false;
  }
  ...
  if (!action) {
    var msg = Translator.trans('Please select an action to perform.');
    alert(msg);
    return false;
  }
