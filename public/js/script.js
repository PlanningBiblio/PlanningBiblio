...
// Fonction utilisée dans les pages /absence et conges/voir.php
...
$(function(){
  ...
  $(document).ready(function() {
    ...
    $('.datepicker.start-date').on('change',function() {
      ...
      if (end == null) {
        $('.datepicker.end-date').bootstrapDP('destroy');
        $('.datepicker.end-date').bootstrapDP({
          defaultViewDate : $(this).bootstrapDP('getDate'),
          format: 'dd/mm/yyyy',
          language: Translator.locale,
          todayHighlight: true,
          autoclose: true,
