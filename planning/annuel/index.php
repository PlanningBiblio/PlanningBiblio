...
Fichier : planning/annuel/index.php
Création : 2 août 2016
Dernière modification : 2 août 2016
@author Jérôme Combes <jerome@planningbiblio.fr>

Description :
Page d'index de gestion des plannings annuels. Affiche la liste des plannings annuels.

Page appelée par le fichier index.php, accessible via le menu Planning / Annuel
*/

require_once "class.annuel.php";

echo "<h2>Plannings annuels</h2>\n";
exit;
// Tableaux
$t=new tableau();
$t->fetchAll();
